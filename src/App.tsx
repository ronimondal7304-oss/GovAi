...
export default function App() {
  ...
  const handleScroll = () => {
    ...
    setActiveDot(Math.min(newIndex, 11)); // max 11 for 12 dots (0-11)
  };
    ...
    <>
          ...
          <div className="hero-grid">
            ...
            <div id="latest-episode" className="featured-episode-card">
              <div className="featured-episode-label-wrap">
                <span className="featured-episode-label"><span className="live-dot"></span>FEATURED EPISODE</span>
              </div>
              ...
              <div className="featured-episode-meta">
                <span>EP 11</span>
                <span className="dot">·</span><span>Featured</span>
              </div>
      ...
      <section id="guests" className="guests-section">
        ...
        <div className="guests-grid">
          ...
          <div className="guest-card">
            <div className="guest-avatar">
              <img src="https://i.ibb.co/7Mvjdvz/bachar.png" alt="Bachar Khawajah" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div className="guest-info">
              <div className="guest-name">Bachar Khawajah</div>
              <div className="guest-company">CIO, City of Burnaby</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="episodes-header">
            ...
            <div className="section-sub">
              ...
              Latest Episodes
              <span className="count">12 episodes</span>
            </div>
          </div>
          ...
          <div className="carousel-wrap">
            ...
            >
              <div onClick={() => !isDragging && setActiveVideo('39Hup1lpEPE')} className="opt1-card" style={{ cursor: 'pointer' }}>
                <div className="thumb" style={{ backgroundImage: 'url(https://img.youtube.com/vi/39Hup1lpEPE/hqdefault.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                  <div className="thumb-content">
                    <div className="ep-tag">EP 12</div>
                  </div>
                  <div className="play-mini"></div>
                </div>
                <div className="info">
                  <div className="meta">
                    <span className="latest">EP 12</span><span className="dot">·</span><span className="latest">Latest</span>
                  </div>
                  <h3>Practical Al, Public Value: How Burnaby Safely Adopts Al</h3>
                  <div className="with">With Bachar Khawajah</div>
                </div>
              </div>
